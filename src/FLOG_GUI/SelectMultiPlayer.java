...
public class SelectMultiPlayer extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    btnStartServer.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/images/btn_hostserver_n.png"))); // NOI18N
    btnStartServer.addMouseListener(
        new java.awt.event.MouseAdapter() {
          public void mouseClicked(java.awt.event.MouseEvent evt) {
    ...
    btnJoin.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/images/btn_joinserver_n.png"))); // NOI18N
    btnJoin.addMouseListener(
        new java.awt.event.MouseAdapter() {
          public void mouseClicked(java.awt.event.MouseEvent evt) {
    ...
    btnStartGame.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/images/btn_startgamem_n.png"))); // NOI18N
    btnStartGame.addMouseListener(
        new java.awt.event.MouseAdapter() {
          public void mouseClicked(java.awt.event.MouseEvent evt) {
