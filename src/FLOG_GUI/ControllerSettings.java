...
public class ControllerSettings {
   ...
   * 'PanelSettings' JPanel and Handles Label icon transition to give the feel
   * of a custom button
   */
    ...
    panelSettings
        ...
        .addMouseListener(
            new MouseListener() {
              ...
              public void mouseClicked(MouseEvent e) {
                ImageIcon imgIcon =
                    new ImageIcon(getClass().getResource("/images/btn_soundon_h.png"));
              ...
              public void mousePressed(MouseEvent e) {
                ImageIcon imgIcon =
                    new ImageIcon(getClass().getResource("/images/btn_soundon_c.png"));
                panelSettings.setIcon_Sound(imgIcon);
              }
              ...
              public void mouseExited(MouseEvent e) {
                ImageIcon imgIcon =
                    new ImageIcon(getClass().getResource("/images/btn_soundon_n.png"));
                panelSettings.setIcon_Sound(imgIcon);
              }
            });
    ...
    panelSettings
        ...
        .addMouseListener(
            new MouseListener() {
              ...
              public void mouseClicked(MouseEvent e) {
                ImageIcon imgIcon =
                    new ImageIcon(getClass().getResource("/images/btn_minus_h.png"));
              ...
              public void mousePressed(MouseEvent e) {
                ImageIcon imgIcon =
                    new ImageIcon(getClass().getResource("/images/btn_minus_c.png"));
                panelSettings.setIcon_VolReduce(imgIcon);
              }
              ...
              public void mouseExited(MouseEvent e) {
                ImageIcon imgIcon =
                    new ImageIcon(getClass().getResource("/images/btn_minus_n.png"));
                panelSettings.setIcon_VolReduce(imgIcon);
              }
            });
  }
