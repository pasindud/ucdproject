                ...
                if (validateEmail(email)) {
                    if (validatePass(pass, conPass)) {
                        ...
                        if (multiplayer.registerUser(uname, email, pass)) {
                            ...
                            JOptionPane.showMessageDialog(
                                    gameScreen, "Something went wrong!", "Try Again", JOptionPane.ERROR_MESSAGE);
                        }
                    } else {
                        JOptionPane.showMessageDialog(
                                gameScreen, "Passwords does Not match!", "Try Again", JOptionPane.ERROR_MESSAGE);
                    }
                } else {
                    JOptionPane.showMessageDialog(
                            gameScreen, "Invalid email!", "Try Again", JOptionPane.ERROR_MESSAGE);
                }
            } else {
                JOptionPane.showMessageDialog(
                        gameScreen, "Invalid User name!", "Try Again", JOptionPane.ERROR_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(
                    gameScreen,
                ...
                .addMouseListener(
                        new MouseListener() {
                            ...
                            public void mouseClicked(MouseEvent e) {
                                ...
                                ImageIcon imgIcon
                                = new ImageIcon(getClass().getResource("/images/btn_register_h.png"));
                                ...
                                || uname.equals(""))) {
                                    ...
                                    JOptionPane.showMessageDialog(
                                            gameScreen, "Details incomplete!", "Try Again", JOptionPane.ERROR_MESSAGE);
                                }
                            }
                            ...
                            public void mousePressed(MouseEvent e) {
                                ImageIcon imgIcon
                                = new ImageIcon(getClass().getResource("/images/btn_register_c.png"));
                                panelRegister.setIcon_Register(imgIcon);
                            }
                            ...
                            public void mouseExited(MouseEvent e) {
                                ImageIcon imgIcon
                                = new ImageIcon(getClass().getResource("/images/btn_register_n.png"));
                                panelRegister.setIcon_Register(imgIcon);
                            }
                        });
                ...
                .addMouseListener(
                        new MouseListener() {
                            ...
                            public void mouseClicked(MouseEvent e) {
                                cancelClick();
                                ImageIcon imgIcon
                                = new ImageIcon(getClass().getResource("/images/btn_cancel_h.png"));
