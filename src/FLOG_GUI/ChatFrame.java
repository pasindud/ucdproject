...
public class ChatFrame extends javax.swing.JFrame {
  ...
  public void setWindow() {
    ...
    this.setLocation(
        gameScreen.getLocationOnScreen().x + gameScreen.getWidth() + 20,
  ...
  private void initComponents() {
    ...
    pnlContainer.add(
        jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(25, 50, 223, 500));

    btnSend.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
    btnSend.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/images/btn_send_n.png"))); // NOI18N
    ...
    pnlContainer.add(
        txtMessage, new org.netbeans.lib.awtextra.AbsoluteConstraints(25, 570, 198, 35));
    ...
    pnlContainer.add(
        pnlTopBorder, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 270, 40));

    jLabel1.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/images/bg_chat.png"))); // NOI18N
    pnlContainer.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 272, 619));

    getContentPane()
        .add(pnlContainer, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 272, 619));

    pack();
  } // </editor-fold>//GEN-END:initComponents

  private void txtMessageActionPerformed(
      java.awt.event.ActionEvent evt) { //GEN-FIRST:event_txtMessageActionPerformed
  ...
  private void btnSendMouseClicked(
      java.awt.event.MouseEvent evt) { //GEN-FIRST:event_btnSendMouseClicked
    // TODO add your handling code here:
    sendClick();
  ...
  private void btnSendMouseEntered(
      java.awt.event.MouseEvent evt) { //GEN-FIRST:event_btnSendMouseEntered
    ImageIcon imgIcon = new ImageIcon(getClass().getResource("/images/btn_send_h.png"));
    btnSend.setIcon(imgIcon);
  } //GEN-LAST:event_btnSendMouseEntered

  private void btnSendMouseExited(
      java.awt.event.MouseEvent evt) { //GEN-FIRST:event_btnSendMouseExited
    ImageIcon imgIcon = new ImageIcon(getClass().getResource("/images/btn_send_n.png"));
    btnSend.setIcon(imgIcon);
  } //GEN-LAST:event_btnSendMouseExited

  private void btnSendMousePressed(
      java.awt.event.MouseEvent evt) { //GEN-FIRST:event_btnSendMousePressed
    ImageIcon imgIcon = new ImageIcon(getClass().getResource("/images/btn_send_c.png"));
    btnSend.setIcon(imgIcon);
  } //GEN-LAST:event_btnSendMousePressed

  private void btnSendMouseReleased(
      java.awt.event.MouseEvent evt) { //GEN-FIRST:event_btnSendMouseReleased
    ImageIcon imgIcon = new ImageIcon(getClass().getResource("/images/btn_send_h.png"));
    btnSend.setIcon(imgIcon);
