  ...
  private void initComponents() {
    ...
    btnDisconnect.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/images/btn_disconnect_n.png"))); // NOI18N
    btnDisconnect.setName("close"); // NOI18N
    pnlTopBorder.add(
        btnDisconnect, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 2, 36, 34));

    btnSettings.setText("settings");
    btnSettings.setName("settings"); // NOI18N
    pnlTopBorder.add(
        btnSettings, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 10, -1, -1));
