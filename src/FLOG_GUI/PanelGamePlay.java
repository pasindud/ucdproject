...
public class PanelGamePlay extends javax.swing.JPanel {
  ...
  public void restLabels() {
    JLabel[] label_array =
        new JLabel[] {
          lblL1, lblL2, lblL3, lblL4, lblL5, lblL6, lblL7, lblL8, lblL9, lblL10, lblL11, lblL12
        };
  ...
  private void initComponents() {
    ...
    btnDisconnect.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/images/btn_exit_n.png"))); // NOI18N
    btnDisconnect.setName("close"); // NOI18N
    pnlTopBorder.add(
        btnDisconnect, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 0, 40, 40));

    btnSettings.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/images/btn_settingst_n.png"))); // NOI18N
    btnSettings.setName("settings"); // NOI18N
    pnlTopBorder.add(
        btnSettings, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 0, -1, 38));
    ...
    lblL1.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/images/ftletter_initial.png"))); // NOI18N
    lblL1.setText("-");
    ...
    lblL3.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/images/ftletter_normal.png"))); // NOI18N
    lblL3.setText("-");
    ...
    btnVowels.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/images/btn_vowels_n.png"))); // NOI18N
    ...
    btnConsonents.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/images/btn_consonent_n.png"))); // NOI18N
    ...
    btnConsonents.addMouseListener(
        new java.awt.event.MouseAdapter() {
          public void mouseClicked(java.awt.event.MouseEvent evt) {
    ...
    pnlBottom.add(
        btnConsonents, new org.netbeans.lib.awtextra.AbsoluteConstraints(478, 111, 204, 39));
    ...
    btnGenerate.setIcon(
        new javax.swing.ImageIcon(
            getClass().getResource("/images/btn_autosearch_n.png"))); // NOI18N
    ...
    btnSubmit.setIcon(
        new javax.swing.ImageIcon(getClass().getResource("/images/btn_submit_n.png"))); // NOI18N
  ...
  private void btnGenerateMouseClicked(
    ...
    if (checkAllLetters()) {
      ...
      FLOG_LOGIC.WordAutoGenerator wordgen = new FLOG_LOGIC.WordAutoGenerator(WordArray);
