...
public class ControllerRoundReadyUp {
    ...
    /**
     * Start Round ReadyUP Timer If you want to Change Round time, then change
     * the value of the RoundReadyUpTime variable at DataForUI class
     */
    public void runTimer() {
        ...
        String message
                = "304 initialLetters " + username + " " + roundNum + " " + firstLetter + " " + secondLetter;
        String channelName = gameScreen.channelName;
        // Update his users data also.
        String[] initLetters = {firstLetter, secondLetter};
        gameScreen.dataForUI.game
                .getPlayerRoundForRound(username, roundNum)
                .setIntialLetters(initLetters);
